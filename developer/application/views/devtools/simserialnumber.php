...
<html> 
<head> 
    <title>Active Fleets(AWC&JEC) sim serial numbers list</title> 
...
<body> 
    <div class="row" style="margin-bottom: 10px"> 
        <div class="col-md-12"> 
             <h2 class="fwb text-center">Active Fleets(AWC&JEC) sim serial numbers list</h2> 
        </div>
    </div> 
    <table class="table table-bordered table-striped" id="mytable"> 
        ...
        <tbody> 
            <?php 
            $start = 0; 
            foreach ($simserialnumber as $datasimserialnumber) 
            { 
                ?> 
                <tr> 
                    <td> 
