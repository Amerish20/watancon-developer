                ...
                data.geoffence_unselect   = geoffence_unselect;
                  ...
                  { "data": "track" },
          		 ...
          		 buttons: [ 
                      ...
                      $('*[data-id="stop_duration"]').addClass("zindexzero");  
                      $('*[data-id="Report"]').addClass("zindexzero");  
                      $("#datetimepicker1").addClass("zindexzero");
                      $("#datetimepicker2").addClass("zindexzero");
   	      ...
   	      $('#speed_alert').DataTable({
			  ...
			  "pageLength": 25,
          		 ...
          		 buttons: [ 
               {
                  ...
                  text: 'Show/Hide Coloumns',
                  action: function ( e, dt, node, config ) {                    
                      $('*[data-id="speed_alert_data"]').addClass("zindexzero");  
                      $('*[data-id="Report"]').addClass("zindexzero");  
                      $("#datetimepicker1").addClass("zindexzero");
                      $("#datetimepicker2").addClass("zindexzero");
                      $.fn.dataTable.ext.buttons.collection.action.call(this, e, dt, node, config);
       ...
       $("#to_geoffence").html(geoffence_to_text);
         ...
         dom: 'lBfrtip',
               buttons: [ 
               {
                        ...
                        text: 'Show/Hide Coloumns',
                        action: function ( e, dt, node, config ) {
                      $('*[data-id="Geoffence_From"]').addClass("zindexzero");  
                      $('*[data-id="Geoffence_To"]').addClass("zindexzero");  
                      $('*[data-id="Report"]').addClass("zindexzero");  
                      $("#datetimepicker1").addClass("zindexzero");
                      $("#datetimepicker2").addClass("zindexzero");
                      $.fn.dataTable.ext.buttons.collection.action.call(this, e, dt, node, config);
